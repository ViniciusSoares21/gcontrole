  ...
  return (
    <main>
      ...
      <div className={style.container}>
        ...
        <p>
          A sua privacidade é importante para nós. É política do gcontrole respeitar a sua 
          privacidade em relação a qualquer informação sua que possamos coletar no site
          <a href="https://www.gcontrole.com"> gcontrole</a>, e outros sites que possuímos e operamos.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>Para mais informações sobre o Google AdSense, consulte <a href="https://policies.google.com/technologies/partner-sites" rel="noopener noreferrer" target="_blank">  Como o Google usa os dados quando você utiliza apps ou sites dos nossos parceiros</a>.</li>
        ...
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o gcontrole oferece no site e com caráter enunciativo, mas não limitativo:</p>
        <ul>
          ...
          <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do gcontrole, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
        </ul>
          <h3>Mais informações</h3>
          <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>
        
        <p><span style={{color: "rgb(68, 68, 68)"}}>Esta política é efetiva a partir de&nbsp;26 May 2023 21:00</span></p>
      </div>
    </main>
  )
}
